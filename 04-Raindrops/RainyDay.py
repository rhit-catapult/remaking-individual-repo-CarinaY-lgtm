...
class Raindrop:
    ...
    def off_screen(self):
        ...
        return self.y > self.screen.get_height() # replace using if/else with just return
...
class Cloud:
    ...
    def rain(self):
        ...
        for k in range (10): # changes amount of rain
